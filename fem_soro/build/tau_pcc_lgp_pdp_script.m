% TAU_PCC_LGP_PDP_SCRIPT   Generate MEX-function tau_pcc_lgp_pdp_mex from
%  tau_pcc_lgp_pdp.
% 
% Script generated from project 'tau_pcc_lgp_pdp.prj' on 22-May-2024.
% 
...
%% Define argument types for entry-point 'tau_pcc_lgp_pdp'.
ARGS = cell(1,1);
ARGS{1} = cell(18,1);
...
%% Invoke MATLAB Coder.
codegen -config cfg tau_pcc_lgp_pdp -args ARGS{1}
