function [tau,M_est,C_est,g_est] = eval_pcc_lgp_pdp(t,chi_,xi_,a_des,omega_d,Kp,Kd,...
...
tau = M_est*ddq_des(t) + C_est*dq_des(t) + g_est + diag(pb.d)*xi_ + diag(pb.k)*chi_ ...
    - Kp * (chi_ - q_des(t)) - Kd * (xi_ - dq_des(t));
