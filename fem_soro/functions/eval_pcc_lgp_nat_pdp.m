function [tau,M_est,C_est,D_est,g_est,g_est_e,D_est_de] = eval_pcc_lgp_nat_pdp(t,chi_,xi_,a_des,omega_d,Kd,...
...
g_est_e = g_est_e + diag(pb.k)*(chi_-q_des(t));
...
tau = M_est*ddq_des(t) + C_est*dq_des(t) ...
    + (eye(N)-heaviside_man((chi_-q_des(t))'*g_est)*(chi_-q_des(t))*(chi_-q_des(t))'./(1e-3 + norm((chi_-q_des(t)))^2) )*g_est - g_est_e ...
