% TAU_LGP_NAT_PDP_SCRIPT   Generate MEX-function tau_lgp_nat_pdp_mex from
%  tau_lgp_nat_pdp.
% 
% Script generated from project 'tau_lgp_nat_pdp.prj' on 21-May-2024.
% 
...
%% Define argument types for entry-point 'tau_lgp_nat_pdp'.
ARGS = cell(1,1);
ARGS{1} = cell(20,1);
...
%% Invoke MATLAB Coder.
codegen -config cfg tau_lgp_nat_pdp -args ARGS{1}
