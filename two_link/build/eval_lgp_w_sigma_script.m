% EVAL_LGP_W_SIGMA_SCRIPT   Generate MEX-function eval_lgp_w_sigma_mex from
%  eval_lgp_w_sigma.
% 
% Script generated from project 'eval_lgp_w_sigma.prj' on 21-May-2024.
% 
...
%% Define argument types for entry-point 'eval_lgp_w_sigma'.
ARGS = cell(1,1);
ARGS{1} = cell(24,1);
...
%% Invoke MATLAB Coder.
codegen -config cfg eval_lgp_w_sigma -args ARGS{1}
